...
$getDetailUser = getAll("SELECT a.id, a.fullname, a.email, a.group_id, a.created_at, b.name 
...
<div class="container grid-user">
    ...
    ?> 
        <form class="mb-3" action="" method="get">
            <input type="hidden" name="module" value="users" id="">
