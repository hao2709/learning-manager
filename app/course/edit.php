    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-6 pd-3">
                ...
                <input ad="description" name="description" type="text" class="form-control" value="<?php 
                        if(!empty($oldData)){
            ...
            <div class="col-6 pd-3">
                ...
                <img width="200px" id="previewImage" class="preview-image p-3" src="<?php echo _HOST_URL; ?><?php echo !empty($oldData['thumbnail']) ? $oldData['thumbnail'] : false; ?>" alt="">
            </div>
